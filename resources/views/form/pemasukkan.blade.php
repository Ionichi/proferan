    ...
    <div class="container col-lg-6">
        ...
        <form id="form-pemasukan">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body text-center">
                                <p>Inputan jenis transaksi penerimaan secara tunai, yang paling mendekati berdasarkan dengan keterangan yang telah disediakan</p>
                            </div>
            ...
            <div class="form-group mb-3">
                ...
                <input type="number" class="form-control" id="potongan" name="potongan" disabled>
                <div class="form-group form-check">
                    <input type="checkbox" class="form-check-input" id="tampilkan-potongan">
                    <label class="form-check-label" for="tampilkan-potongan">Tampilkan Potongan</label>
                </div>
            </div>
            <div class="text-center">
