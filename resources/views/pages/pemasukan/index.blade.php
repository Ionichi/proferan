...
@section('content')
            ...
            <div class="col-12">
                <div class="card-box">
                    <div class="card-header mb-3 bg-dark">
                        <h2 class="text-white">Tabel Pemasukan</h2>
                    </div>
                    <button type="button" class="btn btn-success waves-effect width-md waves-light rounded float-right" data-toggle="modal" data-target="#modalPemasukan">Tambah Pemasukan</button>
                    <br><br><br>
    ...
    {{-- modals --}}
    <div class="modal fade" id="modalPemasukan" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="modalPemasukanTitle" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="modalPemasukanTitle">Form Pemasukan</h4>
                    <button type="button" id="cancel" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="formPemasukan" method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="jenis_transaksi">Jenis Transaksi</label>
                            <i class="fas fa-question-circle information-icon" info="Jenis transaksi penerimaan kas secara tunai, yang paling mendekati berdasarkan dengan keterangan yang telah disediakan."></i>
                        ...
                        <div class="form-group">
                            ...
                            <i class="fas fa-question-circle information-icon" info="Nominal (Rp) dari transaksi yang terjadi."></i>
                            <input type="hidden" id="nominal" name="nominal">
                            <input type="text" class="form-control" id="nominalTransaksi" oninput="formatCurrency(this)" required>
                        </div>
                        <div class="form-group">
                            <label for="keterangan">Keterangan</label>
                            <i class="fas fa-question-circle information-icon" info="Rincian keterangan dari transaksi."></i>
                            <textarea class="form-control" id="keterangan" name="keterangan" placeholder="Masukkan rincian keterangan transaksi." required></textarea>
                        </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" id="savePemasukan" class="btn btn-success">Simpan</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            if($(this).is(':checked')) {
                $('.sl-potongan').append(`
                    <div class="form-group">
                        ...
                        <i class="fas fa-question-circle information-icon" info="Contoh:<br>Terjual sejumlah Rp 100.000 secara tunai dan diperoleh potongan Rp 20.000. Maka input di nominal adalah Rp 100.000 dan input di nominal potongan adalah Rp 20.000."></i>
                ...
                success: function(response) {
                    if(response.code == 422) {
                        ...
                        if(response.code == 200) {
                            $('#tablePemasukan').DataTable().ajax.reload(null, false);
            ...
            $.ajax({
                ...
                success: function(response) {
                    if(response.code == 200) {
                        ...
                        $('#modalPemasukanTitle').text('Form Edit Pemasukan');
